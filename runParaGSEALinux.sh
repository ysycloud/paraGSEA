...
#mpirun -n 2 -ppn 2 -hostfile hostfile ./bin/Cluster_KMeans_ompi 4 12 "data/ES_Matrix_test" "data/Cluster_result_test.txt"

#param list :process_num pernum hostfile thread_num cluster_num filename outfilename
#mpirun -n 2 -ppn 2 -hostfile hostfile ./bin/Cluster_KMeans++_ompi 4 12 "data/ES_Matrix_test" "data/Cluster_result_test.txt"